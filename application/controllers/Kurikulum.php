...
//			echo "save";
	...
	function dataKurikulumDetail() {
		...
		$sql = "SELECT tj.nama_jurusan, tm.kd_mapel, tm.nama_mapel, tkd.kelas, tkd.id_kurikulum_detail, tkd.id_kurikulum 
    			FROM tabel_kurikulum_detail as tkd, tabel_kurikulum as tk, tabel_mapel as tm , tabel_jurusan as tj 
    			WHERE tkd.id_kurikulum=tk.id_kurikulum and tkd.kd_mapel=tm.kd_mapel and tkd.kd_jurusan=tj.kd_jurusan $selected_kelas and tkd.id_kurikulum='$id_kurikulum' and tkd.kd_jurusan='$kd_jurusan'";
