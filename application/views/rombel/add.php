	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3>Formulir Tambah Rombongan Belajar</h3>
			</div>
		</div>
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<br>
							...
							<?php
								echo form_open('rombel/add', 'id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate=""');
							?>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="nama_rombel" placeholder="Masukkan Nama Rombongan Belajar" id="first-name" required="required" class="form-control ">
								</div>
							</div>
