				...
				<div class="x_panel">
					<div class="x_title">
						...
						<ul class="nav navbar-right panel_toolbox">
							<li><?php echo anchor('guru/add', '<i class="fa fa-edit"></i>', 'title="Tambah Data"'); ?></li>
	...
	$(document).ready(function() {
		var t = $('#mytable').DataTable( {
			...
			"columns": [
				...
				{ "data": "nama_guru", "width": "200px", "sClass": "text-center" },
				{ "data": "jenis_kelamin", "width": "200px", "sClass": "text-center" },
				{ "data": "aksi", "width": "200px", "sClass": "text-center" },
			]
		} );
