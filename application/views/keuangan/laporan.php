                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <table class="table table-striped table-bordered dataTable" style="width: 100%" role="grid">
                                    ...
                                    <tr><td>Jenis Pembayaran</td><td><?php echo cmb_dinamis('jenis_pembayaran', 'tabel_jenis_pembayaran', 'nama_jenis_pembayaran', 'id_jenis_pembayaran', 'null', "id='jenis_bayar'")?></td></tr>
