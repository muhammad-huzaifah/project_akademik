...
INSERT INTO `tabel_history_kelas` VALUES (1,5,'T525235',2);
...
CREATE TABLE `tabel_user` (
  ...
  `foto` text DEFAULT NULL,
  PRIMARY KEY (`id_user`),
  KEY `tabel_user` (`id_level_user`),
  CONSTRAINT `tabel_user` FOREIGN KEY (`id_level_user`) REFERENCES `tabel_level_user` (`id_level_user`)
...
INSERT INTO `tabel_user` VALUES (3,'Muhammad Huzaifah','ujeb','cee7c6eb8e6b0a1c43519c060a8feb0b',1,'abang ganteng banget'),(4,'Muhammad Khairu','khairu','1415c8c6613bf9573faf8f0a1212a27e',1,''),(5,'Khaira Bishry','khaira','dce42e0a59674838927a177ebf78ef51',2,''),(6,'Rachmah Octarina','rachmah','0aab374aa8afffd1d19f4287fd78ed96',3,''),(8,'abang iru','iru','930ceaabe2c1db49f191d8b2e5e29374',3,'foto'),(9,'kakak ira','kakira','31140c8d8b1055de24fd051c42e261d2',2,''),(10,'abang ujeb','abangujeb','9422e4a3037abae6101266d3ccc3fee1',2,''),(11,'Mama Ina','mamaina','edea89d746e4057ba72438b313c3c163',3,''),(12,'jeb','jeb123','b8465dda753a091c1cfd7d5f2add6e50',1,''),(13,'ayah ujeb ganteng','ujebganteng','dd8ae26085558617870a19aec014740d',1,''),(14,'abang iru ganteng','abangiru','029d6d92067edb81152c087b09ce7b1b',1,''),(15,'ujeb keren','jebkeren','2fd2a4cbeb56cbe8fbad366b2e0992f2',2,'');
...
-- Dump completed on 2023-05-12 17:01:15
