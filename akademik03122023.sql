...
--
-- Table structure for table `tabel_sms_group`
--

DROP TABLE IF EXISTS `tabel_sms_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tabel_sms_group` (
...
--
-- Dumping data for table `tabel_sms_group`
--

LOCK TABLES `tabel_sms_group` WRITE;
/*!40000 ALTER TABLE `tabel_sms_group` DISABLE KEYS */;
INSERT INTO `tabel_sms_group` VALUES (1,'group 1'),(2,'group 2'),(4,'testing excel');
...
-- Dump completed on 2023-12-03  7:24:07
